...
struct ContentView: View {
    ...
    func startScreenShare() {
        ...
        picker.preferredExtension = "com.wonjongseo.remotecontroler.ScreenShareUploader" //com.wonjongseo.ScreenShareDemo.ScreenShareUploader" // ⚠️ 여기는 실제 확장 번들 ID로 바꿔야 함
